export const Profile = ({
    ...
    <svg width={`${width}px`} height={`${width}px`} viewBox="0 0 20 20" version="1.1" fill="none" stroke="">
        <g stroke-width="0.0002" fill="none" fill-rule="evenodd">
            <g transform="translate(-420.000000, -2159.000000)" fill="currentColor" stroke="">
